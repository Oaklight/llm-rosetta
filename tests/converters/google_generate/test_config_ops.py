...
from llm_rosetta.converters.google_generate.config_ops import GoogleGenerateConfigOps
...
class TestGoogleGenerateConfigOps:
    """Unit tests for GoogleGenerateConfigOps."""
    ...
    def test_ir_generation_config_basic(self):
        ...
        result = GoogleGenerateConfigOps.ir_generation_config_to_p(ir_config)
    ...
    def test_ir_generation_config_empty(self):
        ...
        result = GoogleGenerateConfigOps.ir_generation_config_to_p(
    ...
    def test_ir_generation_config_logit_bias_warning(self):
        ...
        with pytest.warns(UserWarning, match="logit_bias"):
            GoogleGenerateConfigOps.ir_generation_config_to_p(
    ...
    def test_p_generation_config_to_ir(self):
        ...
        result = GoogleGenerateConfigOps.p_generation_config_to_ir(provider)
    ...
    def test_p_generation_config_to_ir_empty(self):
        ...
        result = GoogleGenerateConfigOps.p_generation_config_to_ir({})
        assert result == {}

    def test_p_generation_config_to_ir_non_dict(self):
        """Test non-dict input → empty IR."""
        result = GoogleGenerateConfigOps.p_generation_config_to_ir("invalid")
        assert result == {}
    ...
    def test_ir_response_format_json_object(self):
        ...
        result = GoogleGenerateConfigOps.ir_response_format_to_p(
    ...
    def test_p_response_format_json_object(self):
        ...
        result = GoogleGenerateConfigOps.p_response_format_to_ir(
    ...
    def test_p_response_format_non_dict(self):
        """Test non-dict input → empty IR."""
        result = GoogleGenerateConfigOps.p_response_format_to_ir("invalid")
        assert result == {}
    ...
    def test_response_format_round_trip_json_object(self):
        ...
        provider = GoogleGenerateConfigOps.ir_response_format_to_p(original)
        restored = GoogleGenerateConfigOps.p_response_format_to_ir(provider)
    ...
    def test_ir_stream_config_enabled(self):
        ...
        result = GoogleGenerateConfigOps.ir_stream_config_to_p(
    ...
    def test_ir_stream_config_empty(self):
        ...
        result = GoogleGenerateConfigOps.ir_stream_config_to_p(cast(StreamConfig, {}))
        assert result == {}

    def test_p_stream_config_to_ir(self):
        """Test Google stream param → IR StreamConfig."""
        result = GoogleGenerateConfigOps.p_stream_config_to_ir({"stream": True})
        assert result["enabled"] is True

    def test_p_stream_config_to_ir_empty(self):
        """Test empty stream config → empty IR."""
        result = GoogleGenerateConfigOps.p_stream_config_to_ir({})
        assert result == {}

    def test_p_stream_config_to_ir_non_dict(self):
        """Test non-dict input → empty IR."""
        result = GoogleGenerateConfigOps.p_stream_config_to_ir("invalid")
        assert result == {}
    ...
    def test_ir_reasoning_config_budget_tokens(self):
        ...
        result = GoogleGenerateConfigOps.ir_reasoning_config_to_p(
    ...
    def test_p_reasoning_config_to_ir(self):
        ...
        result = GoogleGenerateConfigOps.p_reasoning_config_to_ir(provider)
    ...
    def test_p_reasoning_config_to_ir_empty(self):
        ...
        result = GoogleGenerateConfigOps.p_reasoning_config_to_ir({})
        assert result == {}

    def test_p_reasoning_config_to_ir_non_dict(self):
        """Test non-dict input → empty IR."""
        result = GoogleGenerateConfigOps.p_reasoning_config_to_ir("invalid")
        assert result == {}
    ...
    def test_reasoning_config_round_trip(self):
        ...
        provider = GoogleGenerateConfigOps.ir_reasoning_config_to_p(original)
        restored = GoogleGenerateConfigOps.p_reasoning_config_to_ir(provider)
    ...
    def test_ir_cache_config_key(self):
        ...
        result = GoogleGenerateConfigOps.ir_cache_config_to_p(
    ...
    def test_ir_cache_config_empty(self):
        ...
        result = GoogleGenerateConfigOps.ir_cache_config_to_p(cast(CacheConfig, {}))
        assert result == {}

    def test_p_cache_config_to_ir(self):
        """Test Google cached_content → IR CacheConfig."""
        result = GoogleGenerateConfigOps.p_cache_config_to_ir(
    ...
    def test_p_cache_config_to_ir_non_dict(self):
        """Test non-dict input → empty IR."""
        result = GoogleGenerateConfigOps.p_cache_config_to_ir("invalid")
        assert result == {}

    def test_cache_config_round_trip(self):
        """Test cache config round-trip."""
        original = cast(CacheConfig, {"key": "my-cache"})
        provider = GoogleGenerateConfigOps.ir_cache_config_to_p(original)
        restored = GoogleGenerateConfigOps.p_cache_config_to_ir(provider)
