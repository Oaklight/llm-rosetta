...
export const I18N = {
  en: {
    ...
    'label.logLevel':'Console Output', 'logLevel.normal':'Normal', 'logLevel.verbose':'Verbose', 'logLevel.debug':'Debug (bodies)',
    ...
    'section.appearance':'Appearance & Display', 'section.rateLimit':'Rate Limiting', 'label.rlEnabled':'Enabled', 'label.rlAlgorithm':'Algorithm', 'label.rlGlobal':'Global', 'label.rlPerIp':'Per IP', 'label.rlPerKey':'Per API Key', 'label.rlPerModel':'Per Model', 'hint.rlGlobal':'All requests combined', 'hint.rlPerIp':'Per client IP address', 'hint.rlPerKey':'Per gateway API key', 'hint.rlPerModel':'Per upstream model name', 'label.credentialReveal':'Credential Reveal', 'hint.credentialReveal':'Controls whether upstream provider API keys can be viewed in plaintext on the Providers page.<br><br><b>Password + ON:</b> authenticated admins can reveal keys.<br><b>Password + OFF:</b> keys are always masked, even for admins.<br><b>No password + ON:</b> not allowed \u2014 automatically forced to OFF.<br><b>No password + OFF:</b> keys are always masked (default).<br><br>An admin password must be configured before this toggle can be enabled.', 'label.disabled':'Disabled', 'label.logRetention':'Log Retention', 'label.requestLogSection':'Request Log & Error Dumps', 'label.opsLogSection':'Server Ops Log', 'label.successMax':'Success Cap', 'label.errorDumpMax':'Error Dump Cap', 'label.errorDumpSection':'Error Dumps', 'label.maxAgeDays':'Max Age (days)', 'label.opsInfoMax':'Info Cap', 'label.opsWarnMax':'Warning/Error Cap', 'label.opsMaxAgeDays':'Max Age (days)', 'btn.cleanup':'Cleanup', 'btn.cleanupOps':'Cleanup Ops Log', 'btn.cleanupLogs':'Cleanup Logs', 'btn.cleanupErrors':'Cleanup Errors', 'btn.cleanupAll':'Cleanup All', 'btn.export':'Export...', 'confirm.cleanupTitle':'Database Cleanup', 'confirm.cleanupMsg':'This will permanently delete all records older than <strong>{days} days</strong>. Type <strong>CLEANUP</strong> to confirm.', 'confirm.cleanupLogsMsg':'This will permanently delete all request logs older than <strong>{days} days</strong>. Type <strong>CLEANUP</strong> to confirm.', 'confirm.cleanupErrorsMsg':'This will permanently delete all error dumps older than <strong>{days} days</strong>. Type <strong>CLEANUP</strong> to confirm.', 'confirm.cleanupOpsMsg':'This will permanently delete all ops log entries older than <strong>{days} days</strong>. Type <strong>CLEANUP</strong> to confirm.', 'toast.cleanupDone':'Cleaned up: {rl} logs, {ed} error dumps, {db} bodies removed. Freed {freed}.', 'toast.cleanupLogsDone':'Cleaned up {count} log entries. Freed {freed}.', 'toast.cleanupErrorsDone':'Cleaned up {ed} error dumps, {db} bodies. Freed {freed}.', 'toast.cleanupOpsDone':'Cleaned up {count} ops log entries. Freed {freed}.', 'toast.cleanupNone':'Nothing to clean up \u2014 no records older than {days} days.', 'toast.exported':'Export downloaded.', 'btn.vacuum':'Vacuum', 'toast.vacuumDone':'Vacuumed — freed {freed}.', 'toast.vacuumNone':'Database is already compact.', 'export.title':'Export Error Dumps', 'export.hint':'Select a date range (optional). Leave empty to export all.',
    ...
    'toast.saved':'Saved', 'toast.error':'Error', 'toast.copied':'Copied to clipboard', 'toast.copyFailed':'Copy failed', 'toast.tokenRotated':'Token rotated', 'toast.retentionMin':'Minimum: success 50,000 / dump 1,000',
    ...
    'col.status':'Status', 'col.tokens':'Tokens', 'col.duration':'Duration', 'col.requests':'Requests',
    'col.eventType':'Event', 'col.severity':'Severity', 'col.message':'Message', 'col.source':'Source',
    'stat.totalRequests':'Total Requests', 'stat.errorRate':'Error Rate',
    'stat.activeStreams':'Active Streams', 'stat.uptime':'Uptime', 'stat.totalTokens':'Total Tokens', 'stat.tokens24h':'Tokens (24h)', 'stat.cacheRead':'Cache↓', 'stat.cacheWrite':'Cache↑', 'stat.reasoning':'Reasoning',
    'token.cacheRead':'Cache read tokens', 'token.reasoning':'Reasoning tokens',
    'tokenUsage.title':'Token Usage Details', 'tokenUsage.details':'details →',
    'tokenUsage.range1d':'1 day', 'tokenUsage.range7d':'7 days', 'tokenUsage.range30d':'30 days',
    'tokenUsage.col.date':'Date', 'tokenUsage.col.requests':'Requests', 'tokenUsage.col.input':'Input', 'tokenUsage.col.output':'Output', 'tokenUsage.col.cacheRead':'Cache↓', 'tokenUsage.col.cacheWrite':'Cache↑', 'tokenUsage.col.reasoning':'Reasoning', 'tokenUsage.col.total':'Total',
    'tokenUsage.summary':'Summary', 'tokenUsage.noData':'No token usage data available.',
    ...
    'profiling.requests':'Requests:', 'profiling.tracing':'Tracing', 'profiling.type':'Type', 'profiling.flamegraph':'Flamegraph',
    ...
    'filter.allStatus':'All Status', 'filter.ok':'OK (2xx/3xx)', 'filter.error':'Error (4xx/5xx)', 'filter.custom':'Custom...', 'filter.statusPlaceholder':'e.g. 429',
    'filter.allEventTypes':'All Events', 'filter.allSeverity':'All Severity', 'filter.allSources':'All Sources',
    'logView.requests':'Request Log', 'logView.ops':'Server Ops Log',
    'severity.info':'Info', 'severity.warning':'Warning', 'severity.error':'Error',
    'event.startup':'Startup', 'event.shutdown':'Shutdown', 'event.configReload':'Config Reload', 'event.keyCreate':'Key Create', 'event.keyUpdate':'Key Update', 'event.keyDelete':'Key Delete', 'event.keyRotate':'Key Rotate', 'event.healthChange':'Health Change', 'event.adminSetup':'Admin Setup', 'event.logCleared':'Log Cleared',
    ...
    'empty.logs':'No requests logged yet', 'empty.opsLog':'No server events recorded yet', 'empty.data':'No data yet',
    ...
    'label.decisionEndpoint':'Decision Endpoint',
    'label.decisionPath':'Decision Path',
    'label.maxToolDescLen':'Max Tool Desc Length',
    'filter.all':'All',
    ...
    'toast.providersAppended':'{count} provider(s) appended',
    'toast.modelsAllExist':'All selected models already exist',
    'toast.modelMerged':"Merged '{name}' as multi-provider model (added {provider})",
    'confirm.mergeModel':"Model '{name}' already exists on provider '{provider}'. Merge into a multi-provider model?",
    'fetch.addProvider':'(+ provider)',
    ...
    'footer.db':'DB', 'footer.ok':'ok', 'footer.err':'err', 'footer.dumps':'Dumps', 'footer.req':'Req',
    'footer.tip.req':'Total requests tracked in the database (rebuilds automatically after cleanup)',
    'footer.tip.ok':'Logged success entries / retention cap (status < 400)',
    'footer.tip.err':'Logged error entries in request log (status \u2265 400)',
    'footer.tip.dumps':'Error dump entries / retention cap',
  ...
  zh: {
    ...
    'label.logLevel':'控制台输出', 'logLevel.normal':'\u6b63\u5e38', 'logLevel.verbose':'\u8be6\u7ec6', 'logLevel.debug':'\u8c03\u8bd5 (\u542b\u8bf7\u6c42\u4f53)',
    'label.autoRefresh':'\u81ea\u52a8\u5237\u65b0', 'label.off':'\u5173\u95ed', 'label.credentialReveal':'\u51ed\u8bc1\u53ef\u89c1', 'label.errorDumps':'\u9519\u8bef\u8be6\u60c5\u8bb0\u5f55', 'label.enabled':'\u5df2\u542f\u7528',
    'section.appearance':'\u5916\u89c2\u4e0e\u663e\u793a', 'section.rateLimit':'\u901f\u7387\u9650\u5236', 'label.rlEnabled':'\u542f\u7528', 'label.rlAlgorithm':'\u7b97\u6cd5', 'label.rlGlobal':'\u5168\u5c40', 'label.rlPerIp':'\u6bcf IP', 'label.rlPerKey':'\u6bcf API Key', 'label.rlPerModel':'\u6bcf\u6a21\u578b', 'hint.rlGlobal':'\u6240\u6709\u8bf7\u6c42\u5408\u8ba1', 'hint.rlPerIp':'\u6bcf\u4e2a\u5ba2\u6237\u7aef IP', 'hint.rlPerKey':'\u6bcf\u4e2a\u7f51\u5173 API Key', 'hint.rlPerModel':'\u6bcf\u4e2a\u4e0a\u6e38\u6a21\u578b', 'label.credentialReveal':'\u51ed\u8bc1\u53ef\u89c1', 'hint.credentialReveal':'控制是否允许在 Provider 页面以明文查看上游 API Key。<br><br><b>有密码 + 开启：</b>通过认证的管理员可以查看明文 Key。<br><b>有密码 + 关闭：</b>Key 始终以掩码形式显示。<br><b>无密码 + 开启：</b>不允许——自动强制关闭。<br><b>无密码 + 关闭：</b>Key 始终以掩码形式显示（默认）。<br><br>启用此开关前必须先配置管理密码。', 'label.disabled':'\u5df2\u7981\u7528', 'label.logRetention':'\u65e5\u5fd7\u4fdd\u7559', 'label.requestLogSection':'请求日志 & 错误记录', 'label.opsLogSection':'服务器运维日志', 'label.successMax':'\u6210\u529f', 'label.errorDumpMax':'\u9519\u8bef\u8bb0\u5f55\u4e0a\u9650', 'label.errorDumpSection':'\u9519\u8bef\u8bb0\u5f55', 'label.maxAgeDays':'\u6700\u5927\u4fdd\u7559\u5929\u6570', 'label.opsInfoMax':'信息上限', 'label.opsWarnMax':'告警/错误上限', 'label.opsMaxAgeDays':'最大保留天数', 'btn.cleanupOps':'清理运维日志', 'btn.cleanup':'\u6e05\u7406', 'confirm.cleanupTitle':'\u6570\u636e\u5e93\u6e05\u7406', 'confirm.cleanupMsg':'\u6b64\u64cd\u4f5c\u5c06\u6c38\u4e45\u5220\u9664\u8d85\u8fc7 <strong>{days} \u5929</strong>\u7684\u6240\u6709\u8bf7\u6c42\u65e5\u5fd7\u548c\u9519\u8bef\u8f6c\u50a8\u3002\u8bf7\u8f93\u5165 <strong>CLEANUP</strong> \u786e\u8ba4\u3002', 'toast.cleanupDone':'\u5df2\u6e05\u7406\uff1a{rl} \u6761\u65e5\u5fd7\u3001{ed} \u6761\u9519\u8bef\u8f6c\u50a8\u3001{db} \u4e2a Body\u3002\u91ca\u653e {freed}\u3002', 'toast.cleanupNone':'\u65e0\u9700\u6e05\u7406\u2014\u2014\u6ca1\u6709\u8d85\u8fc7 {days} \u5929\u7684\u8bb0\u5f55\u3002', 'btn.cleanupLogs':'\u6e05\u7406\u65e5\u5fd7', 'btn.cleanupErrors':'\u6e05\u7406\u9519\u8bef', 'btn.cleanupAll':'\u6e05\u7406\u5168\u90e8', 'btn.export':'\u5bfc\u51fa...', 'confirm.cleanupLogsMsg':'\u6b64\u64cd\u4f5c\u5c06\u6c38\u4e45\u5220\u9664\u8d85\u8fc7 <strong>{days} \u5929</strong>\u7684\u6240\u6709\u8bf7\u6c42\u65e5\u5fd7\u3002\u8bf7\u8f93\u5165 <strong>CLEANUP</strong> \u786e\u8ba4\u3002', 'confirm.cleanupErrorsMsg':'\u6b64\u64cd\u4f5c\u5c06\u6c38\u4e45\u5220\u9664\u8d85\u8fc7 <strong>{days} \u5929</strong>\u7684\u6240\u6709\u9519\u8bef\u8f6c\u50a8\u3002\u8bf7\u8f93\u5165 <strong>CLEANUP</strong> \u786e\u8ba4\u3002', 'confirm.cleanupOpsMsg':'此操作将永久删除超过 <strong>{days} 天</strong>的所有运维日志。请输入 <strong>CLEANUP</strong> 确认。', 'toast.cleanupOpsDone':'已清理 {count} 条运维日志。释放 {freed}。', 'toast.cleanupLogsDone':'\u5df2\u6e05\u7406 {count} \u6761\u65e5\u5fd7\u3002\u91ca\u653e {freed}\u3002', 'toast.cleanupErrorsDone':'\u5df2\u6e05\u7406 {ed} \u6761\u9519\u8bef\u8f6c\u50a8\u3001{db} \u4e2a Body\u3002\u91ca\u653e {freed}\u3002', 'toast.exported':'\u5bfc\u51fa\u5df2\u4e0b\u8f7d\u3002', 'btn.vacuum':'\u6574\u7406', 'toast.vacuumDone':'\u5df2\u6574\u7406\u2014\u2014\u91ca\u653e {freed}\u3002', 'toast.vacuumNone':'\u6570\u636e\u5e93\u5df2\u662f\u6700\u4f18\u72b6\u6001\u3002', 'export.title':'\u5bfc\u51fa\u9519\u8bef\u8bb0\u5f55', 'export.hint':'\u9009\u62e9\u65e5\u671f\u8303\u56f4\uff08\u53ef\u9009\uff09\u3002\u7559\u7a7a\u5bfc\u51fa\u5168\u90e8\u3002',
    ...
    'toast.saved':'\u5df2\u4fdd\u5b58', 'toast.error':'\u64cd\u4f5c\u5931\u8d25', 'toast.copied':'\u5df2\u590d\u5236\u5230\u526a\u8d34\u677f', 'toast.copyFailed':'\u590d\u5236\u5931\u8d25', 'toast.tokenRotated':'Token \u5df2\u8f6e\u6362', 'toast.retentionMin':'\u6700\u4f4e\uff1a\u6210\u529f 50,000 / \u8bb0\u5f55 1,000',
    ...
    'col.eventType':'事件', 'col.severity':'级别', 'col.message':'消息', 'col.source':'来源',
    'stat.totalRequests':'\u603b\u8bf7\u6c42\u6570', 'stat.errorRate':'\u9519\u8bef\u7387',
    'stat.activeStreams':'\u6d3b\u8dc3\u6d41', 'stat.uptime':'\u8fd0\u884c\u65f6\u95f4', 'stat.totalTokens':'\u603b Token', 'stat.tokens24h':'Token (24h)', 'stat.cacheRead':'\u7f13\u5b58\u2193', 'stat.cacheWrite':'\u7f13\u5b58\u2191', 'stat.reasoning':'\u63a8\u7406',
    'token.cacheRead':'\u7f13\u5b58\u8bfb\u53d6 Token', 'token.reasoning':'\u63a8\u7406 Token',
    'tokenUsage.title':'Token \u7528\u91cf\u8be6\u60c5', 'tokenUsage.details':'\u8be6\u60c5 \u2192',
    'tokenUsage.range1d':'1 \u5929', 'tokenUsage.range7d':'7 \u5929', 'tokenUsage.range30d':'30 \u5929',
    'tokenUsage.col.date':'\u65e5\u671f', 'tokenUsage.col.requests':'\u8bf7\u6c42\u6570', 'tokenUsage.col.input':'\u8f93\u5165', 'tokenUsage.col.output':'\u8f93\u51fa', 'tokenUsage.col.cacheRead':'\u7f13\u5b58\u2193', 'tokenUsage.col.cacheWrite':'\u7f13\u5b58\u2191', 'tokenUsage.col.reasoning':'\u63a8\u7406', 'tokenUsage.col.total':'\u603b\u8ba1',
    'tokenUsage.summary':'\u6c47\u603b', 'tokenUsage.noData':'\u6682\u65e0 Token \u7528\u91cf\u6570\u636e\u3002',
    ...
    'profiling.requests':'\u8bf7\u6c42\u6570\uff1a', 'profiling.tracing':'\u8ffd\u8e2a', 'profiling.type':'\u7c7b\u578b', 'profiling.flamegraph':'\u706b\u7130\u56fe',
    ...
    'filter.allStatus':'\u5168\u90e8\u72b6\u6001', 'filter.ok':'\u6b63\u5e38 (2xx/3xx)', 'filter.error':'\u9519\u8bef (4xx/5xx)', 'filter.custom':'\u81ea\u5b9a\u4e49...', 'filter.statusPlaceholder':'\u5982 429',
    'filter.allEventTypes':'全部事件', 'filter.allSeverity':'全部级别', 'filter.allSources':'全部来源',
    'logView.requests':'请求日志', 'logView.ops':'服务器运维日志',
    'severity.info':'信息', 'severity.warning':'警告', 'severity.error':'错误',
    'event.startup':'启动', 'event.shutdown':'关闭', 'event.configReload':'配置重载', 'event.keyCreate':'创建密钥', 'event.keyUpdate':'更新密钥', 'event.keyDelete':'删除密钥', 'event.keyRotate':'轮换密钥', 'event.healthChange':'健康变更', 'event.adminSetup':'管理面板初始化', 'event.logCleared':'日志已清除',
    ...
    'empty.logs':'\u6682\u65e0\u8bf7\u6c42\u8bb0\u5f55', 'empty.opsLog':'暂无服务器事件记录', 'empty.data':'\u6682\u65e0\u6570\u636e',
    ...
    'label.decisionEndpoint':'Decision 端点',
    'label.decisionPath':'Decision 路径',
    'label.maxToolDescLen':'工具描述最大长度',
    'filter.all':'全部',
    'btn.resetFilters':'✕ 重置',
    ...
    'toast.providersAppended':'\u5df2\u8ffd\u52a0 {count} \u4e2a\u670d\u52a1\u65b9',
    'toast.modelsAllExist':'\u6240\u6709\u5df2\u9009\u6a21\u578b\u5747\u5df2\u5b58\u5728',
    'toast.modelMerged':"已将 '{name}' 合并为多服务方模型（添加 {provider}）",
    'confirm.mergeModel':"模型 '{name}' 已存在于服务方 '{provider}'。是否合并为多服务方模型？",
    'fetch.addProvider':'(+ \u670d\u52a1\u65b9)',
    'btn.applyChanges':'\u5e94\u7528\u66f4\u6539',
    'login.subtitle':'Admin \u9762\u677f\u5df2\u542f\u7528\u5bc6\u7801\u4fdd\u62a4',
    'login.btn':'\u767b\u5f55',
    'login.error':'\u5bc6\u7801\u9519\u8bef',
    'label.systemTime':'\u670d\u52a1\u5668\u65f6\u95f4',
    'footer.db':'DB', 'footer.ok':'\u6b63\u5e38', 'footer.err':'\u9519\u8bef', 'footer.dumps':'\u8bb0\u5f55', 'footer.req':'\u8bf7\u6c42',
    'footer.tip.req':'数据库中记录的总请求数（清理后自动重建）',
    'footer.tip.ok':'\u5df2\u8bb0\u5f55\u7684\u6210\u529f\u6761\u76ee / \u4fdd\u7559\u4e0a\u9650\uff08\u72b6\u6001\u7801 < 400\uff09',
    'footer.tip.err':'\u8bf7\u6c42\u65e5\u5fd7\u4e2d\u7684\u9519\u8bef\u6761\u76ee\uff08\u72b6\u6001\u7801 \u2265 400\uff09',
    'footer.tip.dumps':'\u9519\u8bef\u8bb0\u5f55\u6570\u91cf / \u4fdd\u7559\u4e0a\u9650',
