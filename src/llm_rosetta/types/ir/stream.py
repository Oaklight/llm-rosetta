...
class ContentBlockEndEvent(TypedDict):
    ...
    When the ending block is a tool_use block, ``tool_call_id`` identifies
    which tool call has completed, allowing downstream consumers to flush
    accumulated argument buffers.
    """
