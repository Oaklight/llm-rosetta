...
!!! warning "本页内容可能已过时"
    最后验证版本为 llm-rosetta **v0.5.0**（2026-04-12）。当前最新版本为 **v0.11.1**——自本次验证以来已有大量功能变更。下方的路由矩阵和集成结果在方向上仍然准确，但具体行为可能有所不同。计划进行重新验证。
...
- **认证透传**：网关透传上游的认证错误。上游返回 401 表示 API 密钥对目标提供方无效，不是网关问题。
